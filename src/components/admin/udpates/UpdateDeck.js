    ...
    useEffect(() => {
        setDeck(prevState => (
            [{
                ...
                seph: `Corresponds with Kether, source of consciousness and beginnings`,
                role: ``,
                ...
                desc: [],
                revdesc: [],
                major: [`Influenced by`, `The Emperor via Aries`, `Strength via Leo`, `Temperance via Sagittarius`, `The Magician as a One card`],
            },{
                id: 23,
                suit: `wands`,
                title: `Two of Wands`,
                subtitle: `Lord or Dominion`,
                element: [`Elementent of fire`],
                subelem: [],
                astro: [`Mars in the 1st decan of Aries`],
                subastro: [`0-10° of Aries (March 21-30th) Mars at home. The Emperor on his throne.`],
                seph: `Corresponds with Chokmah, explores duality and choices`,
                role: ``,
                ...
                desc: [],
                revdesc: [],
                major: [`Influenced by`, `The Emperor via Aries`, `The Tower via Mars`, `The High Priestess as a Two card`],
            },{
                id: 24,
                suit: `wands`,
                ...
                astro: [`all fire signs`],
                subastro: [`Aries`, `Leo`, `Sagittarius`],
                seph: `Corresponds with Malkuth, sphere of the material world`,
                ...
                desc: [],
                revdesc: [],
                major: [`Influenced by`, `The Emperor via Aries`, `Strength via Leo`, `Temperance via Sagittarius`],
            },{
                id: 33,
                suit: `wands`,
                ...
                seph: `Corresponds with Tiphareth, sphere of death and rebirth`,
                ...
                desc: [],
                revdesc: [],
                major: [`Influenced by`, `Temperance via Sagittarius`],
            },{
                id: 34,
                suit: `wands`,
